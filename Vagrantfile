...
Vagrant.configure(2) do |config|
  ...
  config.vm.define 'vagrant-ansible-citadel' do |node|
      node.vm.hostname = 'citadel'
      node.vm.network :private_network, ip: '192.168.33.43'
      node.hostmanager.aliases = %w(citadel.localdomain citadel.oakensoul.com)
  end
  ...
  # using a specific IP.
  # config.vm.network "private_network", ip: "192.168.33.43", hostname: "citadel"
